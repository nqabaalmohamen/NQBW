...
def seed_faqs_view(request):
    ...
    try:
        ...
        faq_data = [
            ...
            {
                "question": "كيف أستطيع تقديم شكوى أو استفسار أو مقترح تطوير للنقابة؟",
            ...
            {
                "question": "كيف أستعلم عن نتائج كشوفات الطب الشرعي؟",
                "answer": "من خلال قائمة \"الخدمات\" اختر \"الطب الشرعي\"، ستجد هناك كشوفات الطب الشرعي مرتبة من الأحدث للأقدم، ويمكنك الاطلاع على الكشوفات التي تحتوي على الأسماء وتفاصيل اللجان الطبية.",
                "order": 9
            },
        ]
        ...
        return HttpResponse(f"✅ FAQs seeded successfully! Total: {count} FAQs", content_type="text/plain")
    except Exception as e:
        return HttpResponse(f"❌ FAQ seed failed:\n{str(e)}", content_type="text/plain", status=200)
